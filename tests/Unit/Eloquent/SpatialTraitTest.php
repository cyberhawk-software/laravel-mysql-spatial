...
use Cyberhawk\LaravelMysqlSpatial\Exceptions\SpatialFieldsNotDefinedException;
...
class SpatialTraitTest extends BaseTestCase
{
    ...
    public function testInsertUpdateLineStringHasCorrectSql()
    {
        ...
        $this->model->linestring = new \Cyberhawk\LaravelMysqlSpatial\Types\LineString([$point1, $point2]);
        $this->model->save();
    ...
    public function testInsertUpdatePolygonHasCorrectSql()
    {
        $point1 = new Point(1, 2);
        $point2 = new Point(2, 3);
        $linestring1 = new \Cyberhawk\LaravelMysqlSpatial\Types\LineString([$point1, $point2]);
        ...
        $this->model->polygon = new \Cyberhawk\LaravelMysqlSpatial\Types\Polygon([$linestring1, $linestring2]);
        $this->model->save();
    ...
    public function testInsertUpdateMultiPointHasCorrectSql()
    {
        ...
        $this->model->multipoint = new \Cyberhawk\LaravelMysqlSpatial\Types\MultiPoint([$point1, $point2]);
        $this->model->save();
    ...
    public function testInsertUpdateMultiLineStringHasCorrectSql()
    {
        ...
        $this->model->multilinestring = new \Cyberhawk\LaravelMysqlSpatial\Types\MultiLineString([$linestring1, $linestring2]);
        $this->model->save();
    ...
    public function testInsertUpdateMultiPolygonHasCorrectSql()
    {
        ...
        $point4 = new Point(2, 1);
        $linestring2 = new \Cyberhawk\LaravelMysqlSpatial\Types\LineString([$point3, $point4]);
        $polygon1 = new \Cyberhawk\LaravelMysqlSpatial\Types\Polygon([$linestring1, $linestring2]);
        ...
        $linestring4 = new \Cyberhawk\LaravelMysqlSpatial\Types\LineString([$point7, $point8]);
        $polygon2 = new \Cyberhawk\LaravelMysqlSpatial\Types\Polygon([$linestring3, $linestring4]);

        $this->assertFalse($this->model->exists);

        $this->model->multipolygon = new \Cyberhawk\LaravelMysqlSpatial\Types\MultiPolygon([$polygon1, $polygon2]);
        $this->model->save();
    ...
    public function testInsertUpdateGeometryCollectionHasCorrectSql()
    {
        ...
        $linestring1 = new \Cyberhawk\LaravelMysqlSpatial\Types\LineString([$point2, $point3]);

        $this->assertFalse($this->model->exists);

        $this->model->geometrycollection = new \Cyberhawk\LaravelMysqlSpatial\Types\GeometryCollection([$point1, $linestring1]);
        $this->model->save();
